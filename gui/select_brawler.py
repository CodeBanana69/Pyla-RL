...
class SelectBrawler:
    ...
    def __init__(self, data_setter, brawlers):
        ...
        self.filter_entry = ctk.CTkEntry(
            ...
            placeholder_text="Type brawler name...",
            font=theme.ui_font(int(20 * scale_factor)),
        ...
        search_label = ctk.CTkLabel(
            self.app,
            text=header_text,
            font=theme.ui_font(int(20 * scale_factor), "bold"),
        ...
        self.update_images("")
        _btn_radius = int(12 * scale_factor)
        ctk.CTkButton(
            self.app,
            text="Start",
            command=self.start_bot,
            fg_color=theme.INACTIVE,
            hover_color=theme.INACTIVE_HOVER,
            text_color=theme.TEXT_PRIMARY,
            font=theme.ui_font(int(25 * scale_factor), "bold"),
            border_color=theme.ACCENT,
            border_width=int(2 * scale_factor),
            corner_radius=_btn_radius,
        ).place(x=int(390 * scale_factor), y=int((window_height - 60 * scale_factor)))
        ...
        ctk.CTkButton(
            ...
            border_width=int(2 * scale_factor),
            corner_radius=_btn_radius,
        ).place(x=int(10 * scale_factor), y=int((window_height - 60 * scale_factor)))
    ...
    def open_push_all_target_window(self):
        ...
        ctk.CTkLabel(
            ...
            font=theme.ui_font(int(22 * scale_factor), "bold"),
            text_color=theme.ACCENT,
        ).pack(pady=(int(18 * scale_factor), int(10 * scale_factor)))

        button_frame = ctk.CTkFrame(top, fg_color=theme.BG)
    ...
    def open_brawler_entry(self, brawler):
        ...
        ctk.CTkLabel(
            top,
            text=f"Brawler: {brawler}",
            font=theme.ui_font(int(20 * scale_factor), "bold"),
            text_color=theme.ACCENT,
        ).place(x=x_center_label, y=y_title)
        ...
        push_until_label = ctk.CTkLabel(
            top,
            text="Target Amount",
            font=theme.ui_font(int(15 * scale_factor)),
            text_color=theme.TEXT_PRIMARY,
        )
        push_until_entry = ctk.CTkEntry(
            top,
            textvariable=push_until_var,
            fg_color=theme.CARD,
            text_color=theme.TEXT_PRIMARY,
            border_color=theme.ACCENT,
            border_width=int(2 * scale_factor),
            ...
            width=entry_width,
            font=theme.ui_font(int(14 * scale_factor)),
        )

        trophies_label = ctk.CTkLabel(
            top,
            text="Current Trophies",
            font=theme.ui_font(int(15 * scale_factor)),
            text_color=theme.TEXT_PRIMARY,
        )
        trophies_entry = ctk.CTkEntry(
            top,
            textvariable=trophies_var,
            fg_color=theme.CARD,
            text_color=theme.TEXT_PRIMARY,
            border_color=theme.ACCENT,
            border_width=int(2 * scale_factor),
        ...
        win_streak_label = ctk.CTkLabel(
            top,
            text="Current Brawler's Win Streak",
            font=theme.ui_font(int(15 * scale_factor)),
            text_color=theme.TEXT_PRIMARY,
        )
        current_win_streak_entry = ctk.CTkEntry(
            top,
            textvariable=current_win_streak_var,
            fg_color=theme.CARD,
            text_color=theme.TEXT_PRIMARY,
            border_color=theme.ACCENT,
            border_width=int(2 * scale_factor),
        ...
        auto_pick_checkbox = ctk.CTkCheckBox(
            top,
            text="Bot auto-selects brawler",
            variable=auto_pick_var,
            text_color=theme.TEXT_PRIMARY,
            checkbox_height=int(24 * scale_factor),
            font=theme.ui_font(int(14 * scale_factor)),
        ...
        submit_button = ctk.CTkButton(
            ...
            font=theme.ui_font(int(15 * scale_factor), "bold"),
        )
        ...
        def show_trophies_fields():
            ...
            self.wins_button.configure(fg_color=theme.INACTIVE)
            self.trophies_button.configure(fg_color=theme.ACCENT)
        ...
        def show_wins_fields():
            hide_all_fields()
            self.farm_type = "wins"
            self.wins_button.configure(fg_color=theme.ACCENT)
            self.trophies_button.configure(fg_color=theme.INACTIVE)
            # Field 1: Target Amount
            push_until_label.place(x=x_center_label, y=y_field1_label)
            push_until_entry.place(x=x_center_entry, y=y_field1_entry)
        ...
        self.wins_button = ctk.CTkButton(
            farm_type_button_frame,
            text="Win Amount",
            width=int(90 * scale_factor),
        ...
        self.trophies_button = ctk.CTkButton(
            farm_type_button_frame,
            text="Trophies",
